...
export const swarnBharatCards = [
  {
    ...
    description: "Unifying technology, commerce, jobs, and education under one integrated national network.",
    image: "/images/ah1.png",
  },
  {
    id: "prosperity",
    title: "Shared Prosperity",
    description: "Empowering 1.4 billion citizens with universal Swarn Rewards and sustainable opportunities.",
    image: "/images/ah2.png",
  },
  {
    id: "growth",
    title: "Nation-First Growth",
    description: "Engineering world-class renewable energy, smart townships, and sustainable infrastructure.",
...
export const businesses = [
  ...
  },
  {
    number: "09",
    title: "Foundation",
    description: "Empowering communities and driving sustainable social change.",
...
export const projects = [
  {
    ...
    title: "Swarn Mega Marketplace",
    description: "An integrated digital commerce and retail ecosystem empowering thousands of merchants, local sellers, and nationwide consumers.",
  ...
  },
  {
    ...
    index: "02",
    category: "Real Estate & Civil",
    title: "Smart Commercial & Living Spaces",
    description: "Developing sustainable residential townships, modern commercial complexes, and next-gen civil infrastructure.",
  ...
  },
  {
    ...
    title: "National Student Learning Hub",
    description: "Empowering youth with comprehensive academic resources, competitive exam guidance, and skill certification programs.",
  ...
  },
  {
    ...
    title: "Swarn Foundation Initiatives",
    description: "Creating grassroots impact through healthcare drives, women empowerment programs, and rural community development.",
...
export const footerLinks = {
  ...
  connect: [
    ...
    { label: "Career Openings", href: "/careers" },
