  ...
  const offers = [
    {
      ...
      unit: "% off",
      category: "E-Commerce",
      title: "Exclusive deals on e-commerce",
      desc: "Enjoy special discounts across top brands and products on the Swarn Bharat E-Commerce platform.",
      code: "ECOM20"
    },
    {
      id: 2,
      grad: "linear-gradient(155deg,#D5334B,#A31730)",
      accent: "#C21F3A", // crimson
      ...
      title: "Benefits on property bookings",
      desc: "Save on booking fees and get exclusive benefits on selected residential and commercial properties.",
      code: "REAL15"
    },
    {
      id: 3,
      ...
      title: "Membership benefits on matrimonial services",
      desc: "Find your perfect match with exclusive discounts on premium membership plans and services.",
      code: "MATCH25"
    },
    {
      id: 4,
      ...
      title: "Exclusive benefits for students",
      desc: "Access special discounts on courses, resources, and career development programs.",
      code: "STUDENT30"
    }
  ];
  ...
  return (
    <section className={styles.offersSection} aria-label="Offers and discounts">
      <div className={styles.offers}>
        ...
        <div className={styles.offersTrack} ref={trackRef}>
          {offers.map(offer => (
            <article
              key={offer.id}
            ...
            >
              ...
              <div className={styles.offerCardBody}>
                ...
                <div className={styles.offerCardFoot}>
                  ...
                  <Link href="#" className={styles.offerCardLink}>
                    Know more
